...
import VverifiedData from '../../data/verifierData/VverifiedData';

function V_VTable() {
   // Initialize state with employee data
   const [leads, setLeads] = useState(VverifiedData);
     ...
     <Paper elevation={1} sx={{ borderRadius: '5px', margin: '4px', overflow: 'hidden', width: '100%',height:'80%' }}>
       ...
       <TableContainer sx={{ height: '620px',width: '100%' }}>
         <Table stickyHeader  >
           ...
           <TableBody>
             {VverifiedData.map((leadData, index) => (
               <TableRow key={index}>
                 ...
                 <TableCell align="center" sx={cellStyle}>
                   ...
                   >
                     <MenuItem value="Assigned">Verified</MenuItem>
                     <MenuItem value="Not Assigned">Not Verified</MenuItem>
