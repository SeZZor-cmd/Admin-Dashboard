...
import VleadsData from '../../data/verifierData/VleadsData';

function V_LTable() {
  // Initialize state with employee data
  const [leads, setLeads] = useState(VleadsData);
          ...
          <TableBody>
            {VleadsData.map((leadData, index) => (
              <TableRow key={index}>
                ...
                <TableCell align="center" sx={cellStyle}>{leadData.progress}</TableCell>
